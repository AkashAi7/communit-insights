...
class McpClientPlugin {
  ...
  async makeMcpClient(serverUrl, headers) {
    const transport = this.createTransport ? this.createTransport(serverUrl) : await buildSSEClientTransport(serverUrl, headers);
...
//# sourceMappingURL=mcp-client-plugin.mjs.map
//# sourceMappingURL=mcp-client-plugin.mjs.map