...
import { Schema } from '@microsoft/teams.ai';
...
type McpClientPluginCachedValue = Pick<McpClientPluginParams, 'availableTools' | 'headers'>;
/**
 * A map of Mcp client params keyed off of their corresponding urls
 */
type McpClientPluginParamsCache = Record<string, McpClientPluginCachedValue>;
/**
 * A function that creates a transport for the Mcp client
 */
type CreateTransport = (url: string) => Transport;
type McpClientPluginOptions = ClientOptions & {
    /**
     * the Mcp client name
     * @default 'mcpClient'
     */
...
export type { CreateTransport, McpClientPluginCachedValue, McpClientPluginOptions, McpClientPluginParams, McpClientPluginParamsCache, McpClientPluginUseParams, McpClientToolDetails, PromiseOrValue, ValueOrFactory };
